...
interface IAggregationRouterV5 {
    ...
    function and(uint256 offsets, bytes memory data)
        external
        view
        returns (bool);
    ...
    function cancelOrder(OrderLib.Order memory order)
        external
        returns (uint256 orderRemaining, bytes32 orderHash);

    function cancelOrderRFQ(uint256 orderInfo) external;

    function cancelOrderRFQ(uint256 orderInfo, uint256 additionalMask) external;

    function checkPredicate(OrderLib.Order memory order)
        external
        view
        returns (bool);
    ...
    function hashOrder(OrderLib.Order memory order)
        external
        view
        returns (bytes32);
    ...
    function invalidatorForOrderRFQ(address maker, uint256 slot)
        external
        view
        returns (uint256);
    ...
    function or(uint256 offsets, bytes memory data)
        external
        view
        returns (bool);
    ...
    // NB: diverges from the documented interface:
    ...
    function timestampBelowAndNonceEquals(uint256 timeNonceAccount)
        external
        view
        returns (bool);
